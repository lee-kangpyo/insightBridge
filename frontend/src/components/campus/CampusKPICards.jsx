        ...
        >
          ...
          <div className="p-5 flex-1 min-w-0">
            ...
            <div className="flex items-baseline gap-1 mb-3">
              ...
              {card.unit ? (
                <span className="text-xs font-medium text-outline ml-0.5">{card.unit}</span>
              ) : null}
            </div>
            <div className="space-y-1">
              <div className="flex justify-between text-[10px] font-medium">
                <span className="text-outline font-label uppercase tracking-wider">권역 평균</span>
                <span className="text-primary font-bold">{card.regionalAvg}</span>
              </div>
              <div className="flex justify-between text-[10px] font-medium">
                <span className="text-outline font-label uppercase tracking-wider">국가 평균</span>
                <span className="text-primary font-bold">{card.nationalAvg}</span>
              </div>
            </div>
            {card.auxText ? (
