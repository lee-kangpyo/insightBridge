/**
 * 거버넌스 인사이트 — `GET /api/theme/text-blocks`에서 block/line 구조를 받아
 * 프런트에서 `block_code`/`line_role`로 필터링하여 표시.
 */
export default function GovernanceInsights({ title, items, loading }) {
