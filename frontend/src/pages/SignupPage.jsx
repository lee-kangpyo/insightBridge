    ...
    <div className="login-root font-login-body text-on-surface flex flex-col min-h-svh">
      ...
      <div className="relative z-10 flex flex-col flex-1 min-h-svh">
        <header className="flex items-center justify-center py-8">
          <div className="w-16 h-16 bg-primary-container rounded-2xl flex items-center justify-center shadow-xl shadow-primary-container/20">
            <span
        ...
        <main className="flex-1 flex flex-col items-center justify-start px-4 pt-4 pb-12">
          <div className="w-full max-w-md">
            <div className="flex flex-col items-center mb-8">
              <h1 className="font-login-headline text-2xl font-bold text-primary-container tracking-tight text-center">
                회원가입
              </h1>
              <p className="text-on-surface-variant text-sm mt-2 text-center font-medium">
